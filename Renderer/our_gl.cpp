...
//{
//    //这里写的有问题啊，又声明了一个对象，应该用之前的那个对象改图片的颜色
//    RenderWindow rw;
//    //cout<<"color"<<float(tgaColor[0])<<" "<<float(tgaColor[1])<<" "<<float(tgaColor[2])<<endl;
//    QRgb color = qRgb(float(tgaColor[0]), float(tgaColor[1]), float(tgaColor[2]));
